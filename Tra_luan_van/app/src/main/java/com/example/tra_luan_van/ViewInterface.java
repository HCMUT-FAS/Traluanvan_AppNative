...
public class ViewInterface {
    ...
    public ViewInterface( int LV_Ma, String LV_Ten, String LV_TenTiengAnh, String SV1_Ten, String MSSV1, String SV2_Ten, String MSSV2, String GV1_Ten, String GV2_Ten) {
        this.LV_Ma = LV_Ma;
        this.LV_Ten = LV_Ten;
