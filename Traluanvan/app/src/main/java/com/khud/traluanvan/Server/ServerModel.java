...
import com.khud.traluanvan.LuanvanModel;
import com.khud.traluanvan.R;
import com.khud.traluanvan.Traluanvandb;
...
public class ServerModel {
    ...
    public ServerModel(Listener listener) {
...
//        Toast.makeText(context,serverAPIURL,Toast.LENGTH_SHORT).show();
    ...
    public void Login(Context mcontext, String e, String password) {
        ...
        // Creating request with post method.
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, serverAPIURL, body,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject ServerResponse) {
                        try {
                             JSONObject Respone = ServerResponse.getJSONObject("user");
                             userdata =serverController.FetchUser(Respone);
                        } catch (JSONException exception) {
                            exception.printStackTrace();
                        }
                        //Set data change when have respone
                        if (listener != null) {
